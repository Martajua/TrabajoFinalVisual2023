 ...
 * @Controller
 * 
 * @RequestMapping("/gestion_de_datos") public class GestionController {
 * 
 * @GetMapping("listado") public ModelAndView getGestionPage() { ModelAndView
 * modelAndView = new ModelAndView("gestionDatos"); return modelAndView; }
 * 
 * @GetMapping("/categoria/{seleccion}") public ModelAndView getCategoriaPage(
 * 
 ...
 * return modelAndView; }
 * 
 * @GetMapping("/provincia/{seleccion}") public ModelAndView getProvinciaPage(
 * 
 * @PathVariable(value = "seleccion") String seleccion) {
 * 
 * ModelAndView modelAndView = new ModelAndView();
 ...
 * return modelAndView; }
 * 
 * @GetMapping("/sucursal/{seleccion}") public ModelAndView getSucursalPage(
 * 
 * @PathVariable(value = "seleccion") String seleccion) {
 * 
 * ModelAndView modelAndView = new ModelAndView();
 ...
 * return modelAndView; }
 * 
 * @GetMapping("/empleado/{seleccion}") public ModelAndView getEmpleadoPage(
 * 
 * @PathVariable(value = "seleccion") String seleccion) {
 * 
 * ModelAndView modelAndView = new ModelAndView();
 ...
 * return modelAndView; }
 * 
 * @GetMapping("/producto/{seleccion}") public ModelAndView getProductoPage(
 * 
 * @PathVariable(value = "seleccion") String seleccion) {
 * 
 * ModelAndView modelAndView = new ModelAndView();
 ...
 * return modelAndView; }
 * 
 * @GetMapping("/servicio/{seleccion}") public ModelAndView getServicioPage(
 * 
 * @PathVariable(value = "seleccion") String seleccion) {
 * 
 * ModelAndView modelAndView = new ModelAndView();
